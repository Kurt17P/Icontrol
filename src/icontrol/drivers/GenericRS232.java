...
/**
 * Generic RS232 Instruments are registered in <code>Dispatcher.RegisterDeviceClasses</code>
 * with this class as their Instrument-Class. Essentially all functionality to 
 * support generic RS232 Instruments is implemented in class <code>Device</code>.
 * 
 * @author KPP (Kurt Pernstich: pernstich@alumni.ethz.ch)
 * @version 0.1
 */

// TODO check that getInstrumentNameIdentifier and Open do not need to be overwritten
// * hence, this class only overrides the <code>getInstrumentNameIdentifier</code>
// * method, because Instrument-Name-Identifiers are not supported by generic RS232
...
public class GenericRS232 extends Device {
    ...
    private static final Logger m_Logger = Logger.getLogger("iC.Instruments.iC_GenericRS232Instrument");
